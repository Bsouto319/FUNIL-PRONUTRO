...
import { fetchLeads, fetchStats, fetchMariaGlobalMode, setMariaGlobalMode, updateLeadAiMode, signOut, createLead, STAGES, fetchLatestInsight, fetchBancos, sendMessage, assignLead, fetchUsuarios } from "../lib/api";
...
export default function Dashboard({ user }: { user: any }) {
  ...
  const showAllRef = useRef(showAllLeads);
        ...
        <div className="px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          {page === "kanban" && (
            <div className="flex items-center gap-2 ml-2">
              ...
              <button
                onClick={() => { setShowAllLeads(a => { const next = !a; showAllRef.current = next; setTimeout(() => load(), 0); return next; }); }}
                title={showAllLeads ? "Vendo todas as conversas — clique para ver só as suas" : "Ver só as suas conversas"}
